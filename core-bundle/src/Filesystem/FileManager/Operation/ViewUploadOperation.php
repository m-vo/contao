...
class ViewUploadOperation extends AbstractViewOperation
{
    ...
    public function execute(Request $request, ViewOperationContext $context): Response|null
    {
        ...
        if (null === $upload) {
            return $this->render('@Contao/backend/file_manager/operation/upload_select.stream.html.twig', [
        ...
        if($event->isDenied()) {
            return $this->render('@Contao/backend/file_manager/operation/upload_error.stream.html.twig', [
        ...
        return $this->render('@Contao/backend/file_manager/operation/upload_result.stream.html.twig', [
            'target_directory' => $targetDirectory,
        ]);
    }
}
